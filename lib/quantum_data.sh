...
create_net() {
    ...
    #                      quantum net-create --tenant_id $tenant_id net1 --provider:network_type gre --provider:segmentation_id 1)
    tenant_net_id_2=$(get_id quantum net-create --tenant_id $tenant_id net2 --provider:network_type gre --provider:segmentation_id 2)
    ...
    #                         quantum subnet-create --tenant_id $tenant_id --ip_version 4 $tenant_net_id 192.168.199.0/24 --gateway 192.168.199.1 --dns_nameservers list=true 8.8.8.8
    tenant_subnet_id_2=$(get_id quantum subnet-create --tenant_id $tenant_id --ip_version 4 $tenant_net_id_2 192.168.200.0/24 --gateway 192.168.200.1 --dns_nameservers list=true 8.8.8.8)
    ...
    quantum router-interface-add $prov_router_id $tenant_subnet_id_2
}
...
TENANT_NETWORK_NAME="net1" # The Quantum-internal network name
FIXED_RANGE="192.168.199.0/24"       # The IP range for the private tenant network
